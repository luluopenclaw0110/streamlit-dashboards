...
# ===== 產業分析頁面 =====
    ...
    # 產業完整清單
    INDUSTRY_ALL = {
        '晶圓製造': {'2330': '台積電', '2344': '華邦電', '5347': '世界'},
        'IC封測': {'6153': '嘉晶', '6261': '恩得意', '6233': '旺矽'},
        'IC載板': {'5346': '景碩', '3189': '景碩'},
        'ASIC設計': {'3443': '創意', '3661': '世芯-KY', '2255': '矽力-KY'},
        'IP矽智財': {'3443': '創意', '3035': '智原', '6139': '亞翔'},
        '手機晶片': {'2454': '聯發科', '3008': '大立光'},
        'NOR Flash': {'2337': '旺宏', '2406': '撼訊', '2442': '美光'},
        'DRAM製造': {'2344': '華邦電', '2408': '南亞科'},
        '記憶體模組': {'2401': '凌陽', '4966': '系微'},
        'PCB': {'2313': '瀚宇博', '5469': '健鼎', '2383': '台光電'},
        '高階PCB': {'2383': '台光電', '4952': '聯茂', '6213': '湧德'},
        'CCL材料': {'4952': '聯茂', '3003': '健和興'},
        '電源供應': {'2308': '台達電', '6271': '同欣電', '6278': '天宇'},
        '散熱器': {'3324': '雙鴻', '6230': '超眾', '3017': '奇鋐'},
        '光通訊': {'3229': '光环', '4973': '上詮'},
        '矽光子': {'3229': '光环', '4973': '上詮', '3483': '辛耘'},
        '砷化鎵': {'8086': '宏捷科', '6752': '穩懋'},
        '太陽能': {'3516': '碩禾', '3686': '達能', '3563': '茂迪'},
        '金融': {'2884': '玉山金', '2886': '兆豐金', '2887': '台新金', '2891': '中信金'},
    }
