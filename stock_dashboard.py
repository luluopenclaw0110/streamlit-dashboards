...
def main():
    ...
    with tab_industry:
        ...
        # 產業完整清單（舊產業全部保留 + 新增5個新產業）
        INDUSTRY_ALL = {
            # === 原有產業 ===
            '半導體': {'2330': '台積電', '2454': '聯發科', '3034': '聯詠'},
            '電子零組件': {'2327': '國巨', '2478': '大毅', '6271': '虹冠電', '6283': '景碩'},
            '電動車/綠能': {'1532': '勤美', '6214': '精誠', '2201': '裕隆', '1539': '和大'},
            '航運': {'2603': '長榮', '2618': '華航', '2615': '萬海', '2609': '陽明'},
            '電信': {'3045': '台灣大', '2412': '中華電', '3044': '遠傳'},
            '低軌衛星': {'3042': '仲琦', '3704': '合勤控'},
            '金融': {'2887': '台新金', '2886': '兆豐金', '2884': '玉山金', '2891': '中信金', '2883': '開發金'},
            '半導體設備': {'3213': '辛耘', '2484': '敦陽', '6153': '瑞耘', '6202': '盛群', '6238': '聯策'},
            '傳產鋼鐵/塑化': {'2002': '中鋼', '2027': '燁輝', '2105': '正新', '1326': '台化', '1303': '南亞', '1301': '台塑'},
            # === 新增產業 ===
            'AI半導體供應鏈（HVDC/CoWoS）': {'2308': '台達電', '3711': '日月光投控', '3264': '欣銓', '6251': '矽格'},
            '低軌衛星/網通': {'3491': '昇達科', '2313': '華通', '6285': '啟碁', '2314': '台揚'},
            '電動車供應鏈': {'4739': '康普', '4721': '美琪瑪', '5227': '立凱-KY'},
            'ESG綠能/重電': {'1513': '中興電', '3708': '上緯投控', '6875': '泓德能源', '1519': '華城', '9958': '世紀鋼'},
            'CDMO生技': {'6472': '保瑞', '6589': '台康生技', '4728': '永昕生技', '4174': '浩鼎', '6535': '順藥'},
        }
